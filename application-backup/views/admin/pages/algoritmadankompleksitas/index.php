					...
					?>
						<tr>
							...
							<td>
								...
								<a href="<?= base_url("admin/algoritmadankompleksitas/delete/$value->data_id") ?>" onclick="return confirm('Yakin ?')" class="btn btn-sm btn-danger btn-block">HAPUS</a>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url("admin/algoritmadankompleksitas/save_post") ?>" method="post" enctype="multipart/form-data">
