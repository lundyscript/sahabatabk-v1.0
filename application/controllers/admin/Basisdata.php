...
class Basisdata extends CI_Controller
{
	public function __construct()
	{
		parent::__construct();
		$this->load->model("Mbuah_sayur", "basisdata");
	}

	public function index()
	{
		$content = $this->basisdata->getSayur();
		$data["title"] = "Basis Data";
		$data["content"] = $content;
		$data["page"] = "admin/pages/basisdata/index";
	...
	public function detail($id = "")
	{
		...
		$this->load->view("admin/pages/basisdata/detail", $data);
	}
	...
	public function edit($id = "")
	{
		...
		$data["content"] = $content;
		$data["foto"] = $this->db->get_where("ensiklopedia_foto", array("id_master" => $id))->result();
		$this->load->view("admin/pages/basisdata/edit_data", $data);
	}
	...
	public function save_post()
	{
		...
		$insert = $this->basisdata->insert_data($params);
	...
	public function update_post()
	{
		...
		$insert = $this->basisdata->update_data($params, $where);
