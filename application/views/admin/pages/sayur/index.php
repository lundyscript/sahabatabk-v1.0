					...
					?>
						<tr>
							...
							<td>
								...
								<a href="<?= base_url("admin/basisdata/delete/$value->data_id") ?>" onclick="return confirm('Yakin ?')" class="btn btn-sm btn-danger btn-block">HAPUS</a>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="nama" class="form-control" placeholder="Masukkan nama Sayur.." required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="">Jenis Sayur</label>
								<input type="text" name="jenis" class="form-control" placeholder="Masukkan jenis Sayur" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<textarea name="kandungan" id="" class="form-control" rows="4" placeholder="Masukkan kandungan"></textarea>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Manfaat</label>
								<textarea name="manfaat" id="" class="form-control" rows="4" placeholder="Masukkan manfaat"></textarea>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<textarea name="klasifikasi" id="" class="form-control" rows="4" placeholder="Masukkan klasifikasi"></textarea>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Sub Klasifikasi</label>
								<textarea name="sub_klasifikasi" id="" class="form-control" rows="4" placeholder="Masukkan sub klasifikasi"></textarea>
							</div>
						</div>
					</div>
				</div>
